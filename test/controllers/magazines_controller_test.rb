...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { issue: @magazine.issue, picture: @magazine.picture, prints: @magazine.prints, readership: @magazine.readership, status: @magazine.status, subscribers: @magazine.subscribers, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { issue: @magazine.issue, picture: @magazine.picture, prints: @magazine.prints, readership: @magazine.readership, status: @magazine.status, subscribers: @magazine.subscribers, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
