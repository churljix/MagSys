...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { height: @field.height, price: @field.price, title: @field.title, width: @field.width }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { height: @field.height, price: @field.price, title: @field.title, width: @field.width }
    assert_redirected_to field_path(assigns(:field))
  end
