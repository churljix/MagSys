...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { address: @agency.address, phone: @agency.phone, reg_number: @agency.reg_number, title: @agency.title }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { address: @agency.address, phone: @agency.phone, reg_number: @agency.reg_number, title: @agency.title }
    assert_redirected_to agency_path(assigns(:agency))
  end
